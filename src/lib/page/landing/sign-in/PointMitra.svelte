...
<section id="point-mitra" class="relative px-8 h-[28rem] bg-gradient-to-b from-slate-950 to-zinc-900 text-white flex items-center overflow-hidden">
  <div class="mx-auto w-full grid grid-cols-[50%_19%_31%] gap-8 items-center">
    ...
    <div class="space-y-2">
      <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight text-end leading-tight">
         <span class="text-transparent bg-clip-text bg-gradient-to-r from-zinc-400 to-zinc-100">Mitra Seller Burung</span>
      </h1>
      <p class="text-zinc-400 text-end md:text-lg">
        Solusi terpadu untuk mengembangkan bisnis penjualan burung Anda dengan lebih mudah dan terarah.
      </p>
    </div>
    ...
    <!-- Kolom Ketiga -->
    <div>
        oi kanjut, banyak seller yang bingung
    </div>
